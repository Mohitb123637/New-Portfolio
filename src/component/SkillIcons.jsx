...
const Netlify = ({ width = 45, height = 45 }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
      ...
      >
        <path
          fill="#00C7B7"
          d="M200 0L246.919 126.325 373.244 173.244 246.919 220.163 200 346.488 153.081 220.163 26.756 173.244 153.081 126.325z"
        />
        <path
          fill="#00AD9F"
          d="M373.244 173.244L153.081 126.325 26.756 173.244 246.919 220.163 200 346.488z"
        />
        <path fill="#007C75" d="M200 346.488L246.919 220.163 26.756 173.244z" />
        <path fill="#00C7B7" d="M200 0L246.919 126.325 153.081 126.325z" />
      </svg>
    </>
  );
};

const Flowbite = ({ width = 45, height = 45 }) => {
  return (
    <svg
    ...
    >
      ...
      />
      <path
        d="M11.463 4.054l5.579 3.323A4.02 4.02 0 0 1 18.525 9c.332.668.47 1.414.398 2.155a3.07 3.07 0 0 1-.745 1.65 3.108 3.108 0 0 1-1.55.951c-.022.007-.045.005-.07.01-.062.03-.126.057-.191.08l-2.72.667-1.992 2.48c-.18.227-.41.409-.67.534a2.05 2.05 0 0 0 1.995.035c.592-.33 2.15-1.201 4.636-2.892l.28-.19c1.328-.895 3.616-2.442 3.967-4.215a9.94 9.94 0 0 0-1.713-4.154 10.027 10.027 0 0 0-3.375-2.989 10.107 10.107 0 0 0-8.802-.418c1.162.287 2.287.704 3.354 1.243Z"
        fill="#00AD9F"
      />
      <path
...
const DaisyUI = ({ width = 45, height = 45 }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
      ...
      >
        <path
          fill="#8C61FF"
          d="M32 14a6 6 0 110 12 6 6 0 010-12zm0-6a4 4 0 100 8 4 4 0 000-8zM32 38a6 6 0 110 12 6 6 0 010-12zm0-6a4 4 0 100 8 4 4 0 000-8zM44 26a6 6 0 110 12 6 6 0 010-12zm-6-4a4 4 0 100 8 4 4 0 000-8zM20 26a6 6 0 110 12 6 6 0 010-12zm-6-4a4 4 0 100 8 4 4 0 000-8z"
        />
